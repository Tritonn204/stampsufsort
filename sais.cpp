...
unsigned char mask_priv[]={0x80, 0x40, 0x20, 0x10, 0x08, 0x04, 0x02, 0x01};
#define tget(i) ( (t[(i)/8]&mask_priv[(i)%8]) ? 1 : 0 )
#define tset(i, b) t[(i)/8]=(b) ? (mask_priv[(i)%8]|t[(i)/8]) : ((~mask_priv[(i)%8])&t[(i)/8])
